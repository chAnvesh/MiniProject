...
public class UserBean {
	...
	private String secrestAns;
	
	
	public UserBean(long accNo, int userId, String loginPassword,
			String secretQstn, String secrestAns, String transPassword,
			int lockStatus) {
		super();
		this.accNo = accNo;
		this.userId = userId;
		...
		this.secrestAns = secrestAns;
		this.transPassword = transPassword;
		this.lockStatus = lockStatus;
	}

	@Column(name="SECRET_ANSWER")
	public String getSecrestAns() {
		return secrestAns;
	}

	public void setSecrestAns(String secrestAns) {
		this.secrestAns = secrestAns;
	}
